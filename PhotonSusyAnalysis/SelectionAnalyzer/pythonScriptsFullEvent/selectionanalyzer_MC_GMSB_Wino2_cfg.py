...
process.TFileService = cms.Service("TFileService", fileName = cms.string("histoSkimGGMWino2.root") )

test=False
import PhotonSusyAnalysis.SelectionAnalyzer.selectionanalyzer_multi_cfg as baseConfig
doSkimming=True
doAnalysis=True
fileAppendix="GGM_Wino2"
...
process.source = cms.Source("PoolSource",
	    	...
	    	'dcap:///pnfs/cms/WAX/11/store/user/lpcpjm/PrivateMC/FastSim/winolikegrid2/gen/fastsim_1040_960_375.root',
...
process.weightProducer.XS = cms.double(0.05054)
