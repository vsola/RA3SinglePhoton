...
process.TFileService = cms.Service("TFileService", fileName = cms.string("histoSkimGGMBino3.root") )

test=False
import PhotonSusyAnalysis.SelectionAnalyzer.selectionanalyzer_multi_cfg as baseConfig
doSkimming=True
doAnalysis=True
fileAppendix="GGM_Bino3"
...
process.source = cms.Source("PoolSource",
	    	...
	    	'dcap:///pnfs/cms/WAX/11/store/user/lpcpjm/PrivateMC/FastSim/binolikegrid2/gen/fastsim_1840_960_375.root',
...
process.weightProducer.XS = cms.double(0.0037)
