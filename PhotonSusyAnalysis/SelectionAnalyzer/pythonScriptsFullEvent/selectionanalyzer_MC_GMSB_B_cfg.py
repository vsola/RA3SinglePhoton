...
process.TFileService = cms.Service("TFileService", fileName = cms.string("histoSkimGGMB.root") )
...
process.source = cms.Source("PoolSource",
	    	...
	    	'dcap:///pnfs/cms/WAX/11/store/user/lpcpjm/PrivateMC/FastSim/binolikegrid2/gen/fastsim_1280_1200_375.root',      
	)
